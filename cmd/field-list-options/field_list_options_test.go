...
func TestRunList_User_IterationField(t *testing.T) {
	defer gock.Off()
...
func TestRunList_Org_IterationField(t *testing.T) {
	defer gock.Off()
	gock.Observe(gock.DumpRequest)
	// get org ID
	gock.New("https://api.github.com").
...
func TestRunList_Me_IterationField(t *testing.T) {
	defer gock.Off()
	gock.Observe(gock.DumpRequest)
...
func TestRunList_User_SingleSelectField(t *testing.T) {
	defer gock.Off()
	gock.Observe(gock.DumpRequest)
...
func TestRunList_Org_SingleSelectField(t *testing.T) {
	defer gock.Off()
	gock.Observe(gock.DumpRequest)
	// get org ID
	gock.New("https://api.github.com").
...
func TestRunList_Me_SingleSelectField(t *testing.T) {
	defer gock.Off()
	gock.Observe(gock.DumpRequest)
...
func TestRunList_Me_No_Options_Field(t *testing.T) {
	defer gock.Off()
	gock.Observe(gock.DumpRequest)
	...
	assert.Equal(
		t,
		"Field \"FieldTitle\" does not have options.\n",
		buf.String())
}
